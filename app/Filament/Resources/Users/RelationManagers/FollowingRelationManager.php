...
class FollowingRelationManager extends RelationManager
{
    ...
    {
        return __('messages.user.relations.following.title');
    }
    ...
    public function form(Schema $schema): Schema
    {
        return $schema
            ->components([
                Select::make('id')
                    ->label(__('messages.user.relations.following.user'))
                    ->options(
        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('pivot_created_at')
                    ->label(__('messages.user.relations.following.followed_at'))
                    ->dateTime()
                    ->sortable(),
            ])
            ->filters([
